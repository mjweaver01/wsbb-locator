  ...
  if (coaches.length === 0) {
    return (
      <div className="coach-empty">
        ...
        <p className="coach-empty__sub">Try adjusting your filters or search term.</p>
      </div>
    )
  }

  const tiersToShow = activeTier === 'all'
    ? TIER_ORDER
        ...
        return (
          <section key={tier} className="coach-section">
            <div className="coach-section__header">
              <span className="coach-section__title">{SECTION_TITLE[tier]}</span>
